...
const SIdebar2 = ({ routeList }: SidebarProps) => {
    ...
    <>
      <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block">
        <div className="h-16 w-full flex items-center px-8">
          <img
            src="https://media.licdn.com/dms/image/C4D0BAQFeS0MY2pZOEQ/company-logo_200_200/0/1659465415618?e=1689811200&v=beta&t=YVEID8fSFT1IK5zFQEOTOlbRHpGAO1ORc0vg-Lyr1QM"
            style={{
      ...
      {/* <div
        className={
          show
            ? 'w-full h-full absolute z-20  transform  translate-x-0 '
